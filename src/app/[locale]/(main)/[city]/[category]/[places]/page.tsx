    ...
    <div className="w-full">
      <div className="container my-12">
        ...
        <div className={styles.placesContainer}>
          <div className={`${styles.col1} flex flex-col gap-6`}>
            ...
            <div className={styles.Image}>
              <Image className="!relative" fill src={place?.image_url} alt={place?.name} />
            </div>
            <p className="leading-10 text-pretty text-justify z-10">{place?.content?.[0]?.cnt}</p>
            ...
            <div className={styles.contentContainer}>
              <span className="flex items-center gap-x-4">
                ...
                <span className="flex flex-col">
                  ...
                  <span className="font-semibold text-black text-sm">{place?.author}</span>
                </span>
              </span>
              ...
              <span>
                <span className="flex flex-col">
                  ...
                  <span className="font-semibold text-black text-sm">{place?.updated_at?.split(" ")[0]}</span>
                </span>
              </span>
              ...
              <span>
                <span className="flex flex-col">
                  ...
                  <span className="font-semibold text-black text-sm">{place?.category_slug}</span>
                </span>
              </span>
              ...
              <span>
                <span className="flex flex-col">
                  ...
                  <span className="font-semibold text-black text-sm">{place?.sub_category_slug}</span>
                </span>
              </span>
            </div>
          </div>
        ...
        <div className="bg-slate-100 py-6 rounded-lg">
          ...
          <p className="m-0 mt-12 text-center text-xl lg:mb-0 mb-12 text-primary">{t("allPlacesInApp")}</p>
          <div className="w-full grid lg:grid-cols-2 grid-cols-1 items-center">
            <div>
              <Image src={downloadApp} alt="" />
            </div>
            <div className="flex flex-col gap-4 items-center">
              <Button text={t("downloadBazzar")} icon={<BsBasket3Fill />} className="!w-[240px]" />
              <Button text={t("downloadLink")} icon={<DiAndroid />} className="!w-[240px]" />
              <Button text={t("downloadPWA")} icon={<TbDeviceMobileCode />} className="!w-[240px]" />
            </div>
          </div>
        </div>
      </div>
