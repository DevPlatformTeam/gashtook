            ...
            <div className={styles.contactUsDescription}>
                ...
                <div className={styles.form}>
                    <div className={styles["title-desc"]}>
                        ...
                        <span className={styles.desc}>{t("contact-us.descriptionFrom")}</span>
                    </div>
                    <div className={styles.formInputs}>
                        <div>
                            <TextInput type={'text'} inputMode={'numeric'} label={t('contact-us.mobileInputLabel')} name='mobile' id='mobile' placeHolder='09XXXXXXXXXX' />
                            <TextInput type={'text'} inputMode={'numeric'} label={t('contact-us.nameInputLabel')} name='name' id='name' placeHolder={t("contact-us.nameInputPlaceholder")} />
                            <TextInput type={'text'} inputMode={'numeric'} label={t('contact-us.emailInputLabel')} name='email' id='email' placeHolder="email@gmail.com" />
                        </div>
                        <div>
                            <SelectOptionComponent label={t("contact-us.typeMessageInputLabel")} placeholder={t("contact-us.typeMessageInputPlaceholder")} id='select-type-message' name='select-type-message' options={[{id: 1, value: "پیشنهاد"},{id: 2, value: "انتقاد"}]} />
                            <TextareaInputComponent id='message' name='message' label={t("contact-us.messageInputLabel")} placeholder={t("contact-us.messageInputPlaceholder")} minLength={6} maxLength={1000} />
                            <Button text={t("contact-us.sendButton")} textColor='third' color='primary' />
                        </div>
                    </div>
                </div>
            </div>
